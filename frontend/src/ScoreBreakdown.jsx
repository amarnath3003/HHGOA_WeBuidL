...
const ScoreBreakdown = ({ factors, summary, warnings }) => {
  ...
  if (safeFactors.length === 0) {
    return (
      <section className="relative rounded-lg bg-surface-container/50 backdrop-blur-[20px] p-6 md:p-8 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] overflow-hidden border border-white/10">
  ...
  return (
    <section className="relative max-w-5xl mx-auto rounded-2xl bg-surface-container/50 backdrop-blur-[20px] p-4 sm:p-6 md:p-7 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] overflow-hidden border border-white/10">
      ...
      <div className="relative z-10 mb-6 sm:mb-8 rounded-2xl bg-surface-container/50 backdrop-blur-xl p-3 sm:p-5 border border-outline-variant/10 shadow-[0_4px_24px_rgba(0,0,0,0.2)]">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          <div className="rounded-xl bg-surface-container-highest/80 backdrop-blur-md p-4 border border-outline-variant/10 shadow-[inset_0_1px_rgba(255,255,255,0.05)] hover:border-primary/40 hover:bg-surface-container-highest hover:shadow-[0_8px_24px_rgba(142,5,194,0.12)] hover:-translate-y-0.5 transition-all duration-300 group cursor-default">
          ...
          <div className="rounded-xl bg-surface-container-highest/80 backdrop-blur-md p-4 border border-outline-variant/10 shadow-[inset_0_1px_rgba(255,255,255,0.05)] hover:border-tertiary/40 hover:bg-surface-container-highest hover:shadow-[0_8px_24px_rgba(112,11,151,0.12)] hover:-translate-y-0.5 transition-all duration-300 group cursor-default">
        ...
        {safeFactors.map((factor, index) => {
          ...
          return (
            <article
              ...
              className="group relative flex flex-col rounded-2xl bg-surface-container/50 backdrop-blur-md p-4 sm:p-5 border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] hover:border-white/20 hover:bg-white/10 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.4)] transition-all duration-500 overflow-hidden cursor-default"
            >
