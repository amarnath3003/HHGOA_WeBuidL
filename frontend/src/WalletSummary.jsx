    ...
    <section className="space-y-8">
      <div className="space-y-4">
        <div className="flex justify-between items-end">
          <h2 className="text-sm font-bold tracking-tight uppercase">On-Chain Assets</h2>
          <span className="text-[10px] font-mono text-tertiary/70 uppercase tracking-wider">Verified by Nada</span>
        </div>

        <div className="space-y-3">
          <article className="flex items-center justify-between p-4 rounded-xl bg-surface-container-low ghost-border hover:bg-surface-container-high transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[10px] font-mono text-on-surface-variant">Tether USD</div>
              </div>
            </div>
            <div className="text-right">
              <div className="text-sm font-mono font-bold text-tertiary">{balance}</div>
              <div className="text-[10px] text-on-surface-variant">ERC-20</div>
            </div>
          </article>
          ...
          <article className="flex items-center justify-between p-4 rounded-xl bg-surface-container-low ghost-border hover:bg-surface-container-high transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[10px] font-mono text-on-surface-variant">{ensName}</div>
              </div>
            </div>
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          <h2 className="text-sm font-bold tracking-tight uppercase">Collections</h2>
          <span className="text-[10px] font-mono text-on-surface-variant">{nfts.length} Assets</span>
        </div>

        <div className="flex gap-4 overflow-x-auto no-scrollbar pb-2">
          {nfts.map((nft) => (
            <article key={nft.id} className="flex-shrink-0 w-32 group cursor-pointer">
